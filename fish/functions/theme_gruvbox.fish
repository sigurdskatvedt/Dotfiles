...
function __theme_gruvbox_light
  set -l bg 'fb/f1/c7/cc' # Add alpha value for opacity here
  switch $contrast
    case "soft"
      set bg 'f2/e5/bc/cc' # Add alpha value
    case "hard"
      set bg 'f9/f5/d7/cc' # Add alpha value
  end
  command printf "\033]11;rgba:$bg\007" # Use 'rgba' instead of 'rgb'
...
function __theme_gruvbox_dark
  set -l bg '28/28/28/cc' # Add alpha value for opacity here
  switch $contrast
    case "soft"
      set bg '32/30/2f/cc' # Add alpha value
    case "hard"
      set bg '1d/20/21/cc' # Add alpha value
  end
  command printf "\033]11;rgba:$bg\007" # Use 'rgba' instead of 'rgb'
